...
export const sendMail = async function ({ to, subject, html }) {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: "rai.shivansh9848@gmail.com", // gmail
      pass: process.env.MAIL_PASSWORD, // pass
    },
  });
  let info = await transporter.sendMail({
    from: '"E-commerce" <rai.shivansh9848@gmail.com>', // sender address
    to,
    subject,
    html,
  });
 ...
 <head>
   ...
   @media screen {
     @font-face {
       ...
       font-style: normal;
       font-weight: 400;
       src: local('Source Sans Pro Regular'), local('SourceSansPro-Regular'), url(https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600) format('woff');
     }
             ...
             <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
               <table border="0" cellpadding="0" cellspacing="0" width="100%">
                 ...
                 <tr>
                   ...
                   <td align="left" width="20%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>${order.items.length}</strong></td>
                   <td align="left" width="20%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>$${order.amount}</strong></td>
                 </tr>
               </table>
             </td>
           </tr>
                 ...
                 <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                   <tr>
                     <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                       ...
                       <p>${order.selectedAddress[`full-name`]}<br>${order.selectedAddress[`street-address`]}<br>${order.selectedAddress.city},${order.selectedAddress.state},${order.selectedAddress[`
                       postal-code`]}</p>
                       <p>${order.selectedAddress[`phone-number`]}</p>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
           ...
           <tr>
             <td align="center" bgcolor="#D2C7BA" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
               <p style="margin: 0;">You received this email because we received a request for Online Purchase for your account. If you didn't request Online Purchase you can safely delete this email.</p>
             </td>
           </tr>
           <!-- end permission -->
